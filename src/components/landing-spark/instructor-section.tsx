      ...
      <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl font-extrabold text-foreground sm:text-4xl md:text-5xl">
            Conoce a tu <span className="text-accent">Instructora</span>
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-foreground/70 sm:text-xl">
            Aprende de una experta apasionada por el arte de las uñas y dedicada a tu éxito.
          </p>
        </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card rounded-xl">
              ...
              <CardContent className="space-y-4 text-foreground/80">
                <p className="text-lg">
                  Con más de <strong>10 años de experiencia</strong> transformando uñas en obras de arte y una pasión inmensa por enseñar, estoy aquí para ayudarte a desatar tu potencial creativo y convertirte en una técnica de uñas profesional y exitosa.
                </p>
                <p>
                  Mi metodología se enfoca en la <strong className="text-accent">práctica intensiva</strong>, el dominio de las <strong className="text-accent">últimas tendencias</strong> y el desarrollo de una <strong className="text-accent">visión empresarial</strong>. Juntas, haremos que tus sueños en el mundo de la belleza se hagan realidad.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-foreground/70">Más de una década en la industria y cientos de alumnas certificadas.</p>
                        </div>
                    </div>
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-foreground/70">Dominio de las últimas innovaciones y diseños en tendencia.</p>
                        </div>
                    </div>
                    <div className="flex items-start space-x-3">
                         <CheckCircle className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
                     ...
                     <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-foreground/70">Comprometida con tu desarrollo y éxito profesional.</p>
                        </div>
                    </div>
                </div>
              </CardContent>
